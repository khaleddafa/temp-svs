                            ...
                            <div class="row">
                                <div class="col-md-6 mt-20">
                                    <div class="form-group">
                                        ...
                                        <small class="text-warning">{{ __('Minimum ') }}: {{ settings('admin_send_default_minimum').' '.settings('coin_name') }}
                                        <span class="float-right">{{ __('Maximum ') }}: {{ settings('admin_send_default_maximum').' '.settings('coin_name') }}</span></small>
